 ...
 * see https://github.com/datatheorem/AdvertisingID-Android
 */
...
public final class AdvertisingIdClient {
    ...
    public static Info getAdvertisingIdInfo(Context context) throws Exception {
        ...
        if (context.bindService(intent, connection, Context.BIND_AUTO_CREATE)) {
            try {
                ...
                return new Info(adInterface.getId(), adInterface.isLimitAdTrackingEnabled(true));
            } finally {
